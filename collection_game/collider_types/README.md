# p5.js Project
Welcome to your p5.js project! This is your space to experiment ✨

If you are completing a tutorial, use the Starter Code linked in the project.

To get started, read the File Overview, then go to the script.js file to start coding!
...
This is where we will add the JavaScript code for our game. Open this file to get started.
